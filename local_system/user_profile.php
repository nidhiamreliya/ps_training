...
?>
		<!-- Include javascript file -->
  		...
  		<script type="text/javascript" src="js/check_profilepic.js"></script>
		            	...
		            	<input type="file" name="profile_pic" class="form-control" id="profile_pic">
		 				...
		 				<div class="col-md-12">
			 				<?php 
		                		...
		                		{
		                			echo '<span class="text-success">' . $upload_success;
		                		}
		                		echo '</span>';
		           	  		?>
	              		</div>
				...
				<!-- Form for update user information -->
			   	<div class="col-md-6"> 
		        	<form class="form-horizontal reg_form" method="post" action="controllers/user_profile.php" name="edit_profile" id="edit_profile" onsubmit="return edit_user()"> 
			  			<div>
              				<?php 
                				if(isset($error_message['duplicate_user'])) 
                				{
                   					echo '<label class="col-md-8 col-md-offset-4 text-danger">' . $error_message['duplicate_user'] . '</span>';
                				}
                				if(isset($success_msg)) 
                				{
                   					echo '<label class="col-md-8 col-md-offset-4 text-success">' . $success_msg . '</span>';
                				}
              				?>
          				</div>

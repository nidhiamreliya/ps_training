<?php
  ...
  if (isset($_SESSION['duplicate_user']) && count($_SESSION['errors']) > 0)
  {
	...
	<div class="container-fluid">
		<div class="col-md-6 col-md-offset-3">	
          ...
          <div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="text" class="form-control" id="first_name" name="first_name" placeholder="First name" value="<?php echo isset($post_data['first_name']) ? $post_data['first_name']: ''?>">
            <label class="col-md-8 has-error error_class">
              ...
              ?>
  				...
  				<div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last name" value="<?php echo isset($post_data['last_name']) ? $post_data['last_name']: ''?>">
            <label class="col-md-8 error_class">
              ...
              ?>
  				...
  				<div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="email" class="form-control" id="email_id" name="email_id" placeholder="Example@Email.com" value="<?php echo isset($post_data['email_id']) ? $post_data['email_id']: ''?>">
            <label class="col-md-8 error_class">
              <?php 
              ...
              ?>
  				...
  				<div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="text" class="form-control" id="user_name" name="user_name" placeholder="User name" value="<?php echo isset($post_data['user_name']) ? $post_data['user_name']: ''?>">
            <label class="col-md-8 error_class">
              <?php 
            ...
            <label class="col-md-8 error_class">
              ...
              ?>
  				...
  				<div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="text" class="form-control" id="address_line1" name="address_line1" placeholder="Address line1" value="<?php echo isset($post_data['address_line1']) ? $post_data['address_line1']: ''?>">
    				<label class="col-md-8 error_class">
              <?php 
              ...
              ?>
    			...
    			<div class="form-group">
    				...
    				<input type="text" class="form-control" id="address_line2" name="address_line2" placeholder="Address line2" value="<?php echo isset($post_data['address_line2']) ? $post_data['address_line2']: ''?>">
    				<label class="col-md-8 error_class">
              <?php 
              ...
              ?>
  				...
  				<div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="text" class="form-control" id="city" name="city" placeholder="City" value="<?php echo isset($post_data['city']) ? $post_data['city']: ''?>">
            <label class="col-md-8 error_class">
              <?php 
              ...
              ?>
  				...
  				<div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="text" class="form-control" id="zip_code" name="zip_code" placeholder="Zip-code" value="<?php echo isset($post_data['zip_code']) ? $post_data['zip_code']: ''?>">
            <label class="col-md-8 error_class">
              <?php 
              ...
              ?>
  				...
  				<div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="text" class="form-control" id="state" name="state" placeholder="State" value="<?php echo isset($post_data['state']) ? $post_data['state']: ''?>">
            <label class="col-md-8 error_class">
              <?php 
              ...
              ?>
  				...
  				<div class="form-group">
   					...
   					<div class="col-md-8">
    				<input type="text" class="form-control" id="country" name="country" placeholder="Country" value="<?php echo isset($post_data['country']) ? $post_data['country']: ''?>">
            <label class="col-md-8 error_class">
              <?php 
          ...
          <div class="col-md-3">
            <button type="button" class="btn btn-block btn-success btn_submit" onclick="location.href = 'user_login.php';">Login</button>
			    </div>
          </div>
      </form>
		</div>
